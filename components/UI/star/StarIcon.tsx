...
export default function StarIcon({isActive = false, ...props} : IStarIcon) : JSX.Element{
  return (
      <svg className={`${styles.star} ${isActive && styles.active}`} width="20" height="20" viewBox="0 0 20 20" fill="#E2E2E2" xmlns="http://www.w3.org/2000/svg" {...props}>
