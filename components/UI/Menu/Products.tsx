...
export function ProductsIcon({className} : IMenuIcon): JSX.Element {
  return (
    <svg  className={cn(styles.menuIcon, className)} width="24" height="23" viewBox="0 0 24 23" fill="#787D85" xmlns="http://www.w3.org/2000/svg">
