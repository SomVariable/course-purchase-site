...
interface IServeciesIcon extends React.SVGProps<SVGSVGElement>{
  isActive?: boolean;
}

export function ServeciesIcon({isActive = false} : IServeciesIcon): JSX.Element {
  return (
    <svg className={`${styles.menuIcon} ${isActive && styles.active}`} width="24" height="24" viewBox="0 0 24 24" fill="#787D85" xmlns="http://www.w3.org/2000/svg">
