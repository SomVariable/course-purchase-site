...
function Home({ menu, firstCategory }: HomeProps): JSX.Element {
	...
	const test = async () => {
		let { data: products } = await axios.get<ProductModel[]>(`${process.env.NEXT_PUBLIC_DOMAIN}/products`);
		products = products.filter(product => product.categories.includes("photoshop"))
